...
class JWTTestController(Controller):
    ...
    @route(
        "/auth_jwt_model/whoami-public-or-jwt",
        type="http",
    ...
    @route(
        "/auth_jwt_model_cookie/whoami-public-or-jwt",
        type="http",
    ...
    @route(
        "/auth_jwt_model/keycloak/whoami",
        type="http",
    ...
    @route(
        "/auth_jwt_model/keycloak/whoami-public-or-jwt",
        type="http",
